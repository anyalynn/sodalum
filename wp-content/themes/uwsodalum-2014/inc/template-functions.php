...
if ( ! function_exists( 'uw_list_pages') ) :
  ...
  function uw_list_pages( $mobile = false )
  {
    ...
    $ids = ! is_front_page() ? array_map( function($sibling) { return $sibling->ID; }, $siblings ) : array_map( function($sibling) { return $sibling->ID; }, $siblings );
...
if ( ! function_exists('get_uw_breadcrumbs') ) :
  ...
  function get_uw_breadcrumbs()
  {
    ...
    $html = '<li><a href="//sodalum.uw.edu/" title="UW SOD Class Connections">Home</a></li>';
